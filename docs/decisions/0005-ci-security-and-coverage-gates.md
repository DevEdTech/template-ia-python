...
- Adotar GitHub Actions com dois workflows: `ci` (matriz 3.11/3.12/3.13 × Ubuntu/Windows, mais `pre-commit`) e `security` (auditoria de dependências e varredura de segredos, também semanal).
